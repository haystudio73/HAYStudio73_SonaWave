import { PresetTheme, BackgroundConfig, VisualizerConfig, LyricsConfig, ParticleConfig, TrackMetadata, TextBoxItem, FilmLightConfig, ColorGradingConfig, ColorGradingLUT, MasterEQConfig, MasterEQPreset, MasterEQBands, SceneTransitionsConfig, SlideImageItem, TimelineSceneItem } from '../types';

export const CURATED_SLIDE_PRESETS: SlideImageItem[] = [
  {
    id: 'slide-preset-1',
  ...
  {
    id: 'slide-preset-4',
    name: 'Midnight City Glow',
    url: 'https://images.unsplash.com/photo-1509198397868-475647b2a1e5?auto=format&fit=crop&w=1920&q=80',
  },
];

export const DEFAULT_SCENE_TRANSITIONS: SceneTransitionsConfig = {
  enabled: false,
  mode: 'slider',
  images: [
    {
      id: 'slide-1',
      name: 'Slide 1 (Cyberpunk)',
      url: 'https://images.unsplash.com/photo-1514565131-fce0801e5785?auto=format&fit=crop&w=1920&q=80',
    },
    {
      id: 'slide-2',
  ...
  scenes: [
    {
      ...
      transitionType: 'fade',
      transitionDuration: 1.2,
      visualizerType: 'bars-mirrored',
      visualizerPrimaryColor: '#06b6d4',
    ...
    },
    {
      ...
      transitionDuration: 1.2,
      visualizerType: 'radial-bars-peaks',
      visualizerPrimaryColor: '#f59e0b',
      visualizerSecondaryColor: '#ef4444',
    },
    {
      id: 'scene-3',
      time: 16,
      ...
      visualizerType: 'tunnel-vortex',
      visualizerPrimaryColor: '#a855f7',
      visualizerSecondaryColor: '#3b82f6',
    },
    {
      id: 'scene-4',
      time: 24,
      ...
      transitionDuration: 1.2,
      visualizerType: 'starburst-core',
      visualizerPrimaryColor: '#10b981',
      visualizerSecondaryColor: '#6366f1',
    },
  ],
};
...
export const BACKGROUND_PRESETS: BackgroundPresetItem[] = [
  ...
  },
  {
    ...
    nameVi: 'Vũ Trụ 1',
    category: 'space',
    url: 'https://images.unsplash.com/photo-1464802686167-b939a6910659?auto=format&fit=crop&w=1920&q=80',
    thumbnail: 'https://images.unsplash.com/photo-1464802686167-b939a6910659?auto=format&fit=crop&w=300&q=80',
  },
  {
    id: 'bg-space-3',
    name: 'Universe 2',
    ...
    thumbnail: 'https://images.unsplash.com/photo-1502134249126-9f3755a50d78?auto=format&fit=crop&w=300&q=80',
  },
  {
    id: 'bg-dark-1',
  ...
  {
    id: 'bg-dark-3',
    name: 'Performance Stage 1',
    nameVi: 'Sân Khấu 1',
    category: 'dark',
    url: 'https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?auto=format&fit=crop&w=1920&q=80',
    thumbnail: 'https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?auto=format&fit=crop&w=300&q=80',
  },
  {
    id: 'bg-abstract-1',
  ...
  },
  {
    ...
    nameVi: 'Trừu tượng 3',
    category: 'abstract',
    url: 'https://images.unsplash.com/photo-1633596683562-4a47eb4983c5?auto=format&fit=crop&w=1920&q=80',
    thumbnail: 'https://images.unsplash.com/photo-1633596683562-4a47eb4983c5?auto=format&fit=crop&w=300&q=80',
  },
  {
    id: 'bg-abstract-4',
    name: 'Abstract 4',
    ...
    thumbnail: 'https://images.unsplash.com/photo-1550859492-d5da9d8e45f3?auto=format&fit=crop&w=300&q=80',
  }
];
...
export const DEFAULT_VISUALIZER: VisualizerConfig = {
  ...
  threeDSettings: {
    ...
    cubeSpacing: 0.35,
    cubeHeightScale: 1.6,
    cubeShading: 'metallic',
    sphereRadius: 13,
    sphereDetail: 2,
    sphereSpikeIntensity: 1.4,
    sphereStyle: 'solid-facets',
    sphereCorePulse: true,
    knotP: 2,
    knotQ: 3,
    knotTubeRadius: 1.8,
    knotAudioRipple: 1.2,
    ...
    terrainSpeed: 1.0,
    terrainHeightScale: 1.4,
    terrainCyberSun: true,
    tunnelShape: 'hexagon',
    tunnelRingCount: 18,
    tunnelSpeed: 1.4,
    tunnelTwist: 12,
    ...
    dnaRungCount: 26,
    dnaDualColor: true,
    galaxyParticleCount: 1200,
    galaxyArms: 3,
    galaxyExpansion: 1.5,
    galaxyTwist: 1.8,
    haloRingCount: 4,
    haloSpinSpeed: 1.2,
    haloSparkTrails: true,
  },
};
...
export const DEFAULT_PARTICLES: ParticleConfig = {
  ...
  rainLengthScale: 1.2,
  rainSplash: true,
  // Speed lines defaults
  speedLineMode: 'horizontal',
  speedLineDirection: 'right-to-left',
  speedLineTilt: 0,
  speedLineVerticalCenter: 'center',
  speedLineCenterY: 50,
  speedLineHorizontalCenter: 'center',
  speedLineCenterX: 50,
  speedLineSpeed: 1.0,
  speedLineLength: 140,
  speedLineRandomLength: 55,
  speedLineWidth: 2.5,
  speedLineBlur: 5,
  // Silk ribbon defaults
  ribbonLength: 160,
  ribbonThickness: 8,
  ribbonTwist: 1.8,
  ribbonGlow: 15,
...
export const DEFAULT_TRACK: TrackMetadata = {
  ...
  artistUppercase: false,
  subtitleTitleGap: 6,
  titleArtistGap: 8,
  logoAnimation: 'none',
  logoAnimationSpeed: 1.0,
