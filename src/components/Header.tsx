...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="h-16 border-b border-neutral-800/80 bg-neutral-950/90 backdrop-blur-md px-3 sm:px-4 flex items-center justify-between z-30 sticky top-0">
      {/* Brand Zone */}
      <div className="flex items-center gap-2.5 sm:gap-3">
        <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-rose-500 via-purple-500 to-cyan-400 p-[1.5px] flex items-center justify-center shadow-lg shadow-rose-500/20">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-[10px] text-rose-400/90 font-medium tracking-wider uppercase hidden sm:inline">
      ...
      <div className="flex items-center gap-1.5 sm:gap-2">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-purple-950/40 hover:bg-purple-900/60 border border-purple-700/50 hover:border-purple-500 text-xs font-semibold text-purple-200 transition-all cursor-pointer shadow-sm shadow-purple-950"
        >
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-neutral-900/80 hover:bg-neutral-800 border border-neutral-700/60 text-xs font-medium text-neutral-200 transition-all cursor-pointer hover:border-rose-500/50"
        >
          <Sparkles className="w-3.5 h-3.5 text-rose-400" />
          <span className="hidden md:inline">Mẫu thiết kế</span>
        ...
        <div className="relative group">
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-xl bg-neutral-900/80 hover:bg-neutral-800 border border-neutral-700/60 text-xs font-medium text-neutral-200 transition-all cursor-pointer"
          >
            <Music className="w-3.5 h-3.5 text-cyan-400" />
            <span className="hidden lg:inline">Nhạc mẫu</span>
          </button>
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 rounded-xl bg-gradient-to-r from-rose-500 to-purple-600 hover:from-rose-600 hover:to-purple-700 text-white text-xs sm:text-sm font-semibold shadow-lg shadow-rose-500/25 transition-all cursor-pointer active:scale-95"
        >
